...
// =======================
  update(time, delta) {
      // ...existing code...
      // -----------------
      // RAIN COLLISION LOGIC (moved from global scope)
      // -----------------
      if (gameState.isRaining && gameState.raindrops) {
        ...
        for (let i = raindrops.length - 1; i >= 0; i--) {
          ...
          if (!raindropDestroyed && Math.abs(raindrop.x - gameState.player.x) < 40 && Math.abs(raindrop.y - gameState.player.y) < 40) {
            ...
            if (distanceToPlayer < 30) {
              ...
              if (gameState.nearFire && typeof gameState.closestFireDistance !== 'undefined' && typeof playerBodyLength !== 'undefined' && gameState.closestFireDistance < playerBodyLength * 2) {
                const distanceInWidths = gameState.closestFireDistance / playerBodyLength;
          ...
          // ...existing raindrop collision logic for shelter, fire, bucket...
        }
      }
    ...
    for (let i = raindrops.length - 1; i >= 0; i--) {
      ...
      if (!raindropDestroyed && Math.abs(raindrop.x - gameState.player.x) < 40 && Math.abs(raindrop.y - gameState.player.y) < 40) {
        ...
        if (distanceToPlayer < 30) {
          ...
          if (underTree || underShelter) newTemp -= 5;
          if (gameState.nearFire && gameState.closestFireDistance < playerBodyLength * 2) {
            const distanceInWidths = gameState.closestFireDistance / playerBodyLength;
            if (distanceInWidths > 1 && distanceInWidths <= 2) newTemp += 7;
          }
  ...
  if (touchingFire && gameState.closestFireDistance < playerBodyLength) {
